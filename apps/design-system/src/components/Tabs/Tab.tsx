import { type ComponentProps, type HTMLAttributes, forwardRef, useEffect, useRef } from 'react'
...
const Tab = forwardRef<HTMLButtonElement, ComponentProps<typeof ReachTab> & HTMLAttributes<HTMLButtonElement>>(
  ({ children, ...props }, ref) => {
