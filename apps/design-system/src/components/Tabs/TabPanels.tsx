import { type ComponentProps, forwardRef, type HTMLAttributes, useEffect, useRef, useState } from 'react'
...
type Props = ComponentProps<typeof ReachTabPanels> &
...
const TabPanels = forwardRef<HTMLDivElement, Props>(({ disableHeightAnimation = false, ...props }, ref) => {
  const [height, setHeight] = useState(0)
  const wrapperRef = useResizeObserver((bounds) => setHeight(bounds.height), 100)
